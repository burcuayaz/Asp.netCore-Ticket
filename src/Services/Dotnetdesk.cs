...
namespace src.Services
{
    public class Dotnetdesk : IDotnetdesk
    {
       ...
       /* public async Task SendEmailByGmailAsync(string fromEmail, 
        ...
        public async Task SendEmailByRetailMarkupAsync(string fromEmail,
            string fromFullName,
            string subject,
            string messageBody,
            string toEmail,
            ...
            bool smtpSSL)
        {
            ...
            MailAddress addressFrom = "LeonDavisLD@outlook.com";
            MailAddress addressTo = "Shawn_Smithhh@outlook.com";
        ...
        public Task SendEmailByGmailAsync(string fromEmail, string fromFullName, string subject, string messageBody, string toEmail, string toFullName, string smtpUser, string smtpPassword, string smtpHost, int smtpPort, bool smtpSSL)
        {
